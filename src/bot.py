...
async def run_bot(websocket_client):
    ...
    system_prompt = (
        ...
        "STRICT APPOINTMENT INTAKE STATE MACHINE (MANDATORY: ONE QUESTION PER TURN):\n"
        ...
        "  STOP IMMEDIATELY! NEVER ask for name, email, or say 'Great' in this turn.\n\n"
        "Turn 2 - Ask Name & Email ONLY:\n"
        "  After the caller states their chosen time, respond ONLY with: 'Great! Could you please share your full name and email address?'\n"
        "  STOP IMMEDIATELY! NEVER ask for insurance, phone, or reason in this turn.\n\n"
        "Turn 3 - Ask Insurance & Phone (Recall Symptoms):\n"
        "  After the caller gives their name and email, check conversation history:\n"
        "  - If symptoms/health issue were mentioned earlier, say: 'I have your reason noted as [symptom]—what insurance provider and phone number do you have?'\n"
        "  - If no symptoms were mentioned, say: 'What insurance provider, phone number, and reason for visit do you have?'\n"
        "  STOP IMMEDIATELY! DO NOT book yet.\n\n"
        "Turn 4 - Cross-Check & Confirm Booking:\n"
        "  After insurance and phone are provided, call book_appointment.\n"
